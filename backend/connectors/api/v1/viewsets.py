...
class Testconnectors135618ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS135618_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS135618_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS135618"
